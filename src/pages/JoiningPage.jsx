          ...
          {items.length === 0 ? (
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 12 }}>
              {items.map((it) => {
                ...
                const joinDt = it.joiningAt ? new Date(it.joiningAt) : null;
                const msLeft = joinDt && !Number.isNaN(joinDt.getTime()) ? joinDt.getTime() - nowTick : null;
                    ...
                    <div style={{ display: 'grid', gap: 16 }}>
                      ...
                      <div className="row" style={{ alignItems: 'flex-start', gap: 12, flexWrap: 'wrap' }}>
                        <div style={{ flex: 1, minWidth: 240 }}>
                          <div style={{ fontWeight: 700, fontSize: '16px' }}>{it.candidateName}</div>
                        ...
                        <div style={{ textAlign: 'right' }}>
                          ...
                          <div style={{ fontWeight: 700, fontSize: '15px', marginTop: 2 }}>
                            {it.joiningAt ? fmtDateTime(it.joiningAt) : 'Not set'}
                          </div>
                          {msLeft != null && (
                            <div style={{ marginTop: 4 }}>
                              <span className="badge" style={{ background: msLeft < 0 ? '#ef4444' : '#22c55e', color: '#fff', fontFamily: 'monospace' }}>
