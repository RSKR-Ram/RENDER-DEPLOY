  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { key: 'eaTech', label: 'Technical Tests', to: '/ea/tech', portalKey: 'PORTAL_EA_TECH', roles: ['EA', 'ADMIN'], preload: () => import('../../pages/EaTechPage.jsx') },
      ],
    },
    {
      key: 'hr',
    ...
    },
    {
      key: 'admin',
      title: 'Admin',
      items: [{ key: 'admin', label: 'Admin', to: '/admin', portalKey: 'PORTAL_ADMIN', roles: ['ADMIN'], preload: () => import('../../pages/AdminPage.jsx') }],
    },
  ];
}
